...
export const HeroPage = () => {
  const { features, callsToAction, resources, recentPosts } = data;
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Transition
                          ...
                          leaveTo='opacity-0 translate-y-1'
                        >
                          <Popover.Panel static className='absolute left-1/2 z-10 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-md px-0'>
                            <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden'>
                              <div className='relative grid gap-6 bg-white px-5 py-6 gap-8 p-8'>
                                {resources.map((item) => (
                                  <a key={item.name} href={item.href} className='-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50'>
